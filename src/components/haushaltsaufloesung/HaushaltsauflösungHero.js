      ...
      <div className="max-w-[1400px] mx-auto w-full relative z-10">
        <div className="max-w-3xl flex flex-col gap-6">
          ...
          <motion.h1
            ...
            Wir übernehmen das{" "}
            <span style={{ color: "#007DF8", display: "block", fontWeight: 900 }}>für Sie.</span>
          </motion.h1>
          ...
          <motion.p
            ...
            Haushaltsauflösungen nach einem Todesfall, beim Umzug ins Pflegeheim
            oder nach einem Auszug – einfühlsam, diskret und vollständig.
          </motion.p>
